...
# Activate spliceAI python virtual environment
#cd /mainfs/scratch/lb3e23/spliceAI_env/
#source spliceAI/bin/activate

# Variables declaration
input="/mainfs/scratch/lb3e23/analysed/rnaseq/batch4/gatk/A_FKRN/A_FKRN_vep_filtered.vcf"
...
# SpliceAI command
spliceai -I $input -O $output -R $genome -A $annotation -D 500